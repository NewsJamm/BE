 ...
 */
public class LocalLoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String PASSWORD_KEY = "name";
    ...
    public LocalLoginAuthenticationFilter(ObjectMapper objectMapper) {
